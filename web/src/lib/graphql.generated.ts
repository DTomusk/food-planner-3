...
export type GetEditRecipeQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetEditRecipeQuery = { __typename?: 'Query', recipe?: { __typename?: 'Recipe', id: string, author: { __typename?: 'User', id: string, username: string }, currentVersion: { __typename?: 'RecipeVersion', name: string, description: string, prepMins: number, cookMins: number, portions: number, version: number, imgSrc?: string | null, animalProductLevel: number, containsGluten: boolean, createdAt: any, publishedAt?: any | null, ingredientUsages: Array<{ __typename?: 'IngredientUsage', quantity: number, unit: { __typename?: 'Unit', val: number, symbol: string }, ingredient: { __typename?: 'Ingredient', id: string, name: string, counter?: string | null, plural?: string | null, counterPlural?: string | null } }>, source: { __typename?: 'RecipeSource', type: number, url?: string | null, bookTitle?: string | null, bookPage?: number | null, instructions?: string | null } }, draftVersion?: { __typename?: 'RecipeVersion', name: string, description: string, prepMins: number, cookMins: number, portions: number, version: number, imgSrc?: string | null, animalProductLevel: number, containsGluten: boolean, createdAt: any, publishedAt?: any | null, ingredientUsages: Array<{ __typename?: 'IngredientUsage', quantity: number, unit: { __typename?: 'Unit', val: number, symbol: string }, ingredient: { __typename?: 'Ingredient', id: string, name: string, counter?: string | null, plural?: string | null, counterPlural?: string | null } }>, source: { __typename?: 'RecipeSource', type: number, url?: string | null, bookTitle?: string | null, bookPage?: number | null, instructions?: string | null } } | null } | null };
...
export type GetRecipeVersionsQuery = { __typename?: 'Query', recipe?: { __typename?: 'Recipe', versions: Array<{ __typename?: 'RecipeVersion', version: number, createdAt: any, publishedAt?: any | null }> } | null };
...
export const GetEditRecipeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetEditRecipe"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"recipe"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"currentVersion"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"RecipeVersionFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"draftVersion"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"RecipeVersionFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"RecipeVersionFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"RecipeVersion"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"ingredientUsages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"quantity"}},{"kind":"Field","name":{"kind":"Name","value":"unit"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"val"}},{"kind":"Field","name":{"kind":"Name","value":"symbol"}}]}},{"kind":"Field","name":{"kind":"Name","value":"ingredient"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"counter"}},{"kind":"Field","name":{"kind":"Name","value":"plural"}},{"kind":"Field","name":{"kind":"Name","value":"counterPlural"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"prepMins"}},{"kind":"Field","name":{"kind":"Name","value":"cookMins"}},{"kind":"Field","name":{"kind":"Name","value":"portions"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"source"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"bookTitle"}},{"kind":"Field","name":{"kind":"Name","value":"bookPage"}},{"kind":"Field","name":{"kind":"Name","value":"instructions"}}]}},{"kind":"Field","name":{"kind":"Name","value":"imgSrc"}},{"kind":"Field","name":{"kind":"Name","value":"animalProductLevel"}},{"kind":"Field","name":{"kind":"Name","value":"containsGluten"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"publishedAt"}}]}}]} as unknown as DocumentNode<GetEditRecipeQuery, GetEditRecipeQueryVariables>;
