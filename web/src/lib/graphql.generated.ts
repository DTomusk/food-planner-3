...
export type GetRecipeVersionQuery = { __typename?: 'Query', recipe?: { __typename?: 'Recipe', id: string, author: { __typename?: 'User', id: string, username: string }, version?: { __typename?: 'RecipeVersion', name: string, description: string, prepMins: number, cookMins: number, portions: number, version: number, imgSrc?: string | null, animalProductLevel: number, containsGluten: boolean, ingredientUsages: Array<{ __typename?: 'IngredientUsage', quantity: number, unit: { __typename?: 'Unit', val: number, symbol: string }, ingredient: { __typename?: 'Ingredient', id: string, name: string, counter?: string | null, plural?: string | null, counterPlural?: string | null } }>, source: { __typename?: 'RecipeSource', type: number, url?: string | null, bookTitle?: string | null, bookPage?: number | null, instructions?: string | null } } | null } | null };
